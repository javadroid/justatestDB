      ...
      <main className="">
        ...
        <section className="bg-color-bg_light-100 py-20">
          <div className="mx-auto max-w-7xl lg:flex lg:flex-col">
            <div className="px-1">
              <h2 className="text-center font-extrabold text-color-primary_darken md:text-2xl">
                Check How it Works
              </h2>
              <h1 className="mt-4 text-center font-extrabold md:text-4xl">
            ...
            <div className="md:flex md:items-baseline md:justify-center md:space-x-5">
              <div className="lg flex flex-col items-center rounded-3xl bg-color-bg_primary-500 py-5">
                ...
                <div className="flex flex-col">
                  <h3 className="w-3/4 self-center text-center font-bold md:text-2xl">
                    Have you registered on Facebook?
                  </h3>
                  <p className="self-center px-4 pt-4 text-left text-xs font-medium md:w-3/4 md:text-base">
