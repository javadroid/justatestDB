      ...
      <div className="m-auto px-4 lg:px-0">
        <div className="max-w-6xl my-8 mx-auto md:px-8">
          ...
          <div className=" font-medium text-[0.60rem] sm:text-sm space-y-2 md:text-justify">
            <p>1. Newsems takes financial liability for client&apos;s account balance at any particular time except the cases when the client&apos;s account details (login, password) were disclosed by the client himself or by all means and for any reason on the Internet. Company&apos;s financial liability begins with the first successful customer&apos;s payment to the Newsems and lasts up to the full expenditure of customer&apos;s funds.</p>
            <p>2. The only official ways of depositing are the ways listed at the company&apos;s official websites (Newsems.com; Newsems.ru), in official desktop application and in telegram bot. Client bears all the risks related to the usage of the payment service providers. The payment service providers are not partners of the company and do not account to the company. Newsems is not liable for any canceling or delay of funds transaction which may occur due to the payment service provider. The Company is not liable for the operation of any third-party service providers, which the customer may use to make any payment. In case that client has any complaints related to any of the payment service providers, he should contact the support of this payment service provider.</p>
            ...
            <p>5. Newsems is not a tax agent and therefore shall not provide clients&apos; financial information to any third parties. This information will not be disclosed unless officially requested by government authorities.</p>
            ...
            <p>7. Newsems receives a payment only in the amount specified by the client on the Website, and does not take responsibility for user&apos;s costs related to the mentioned above additional expenses.</p>
            <p>8. If the funds have not been accrued to the Newsems account balance for any reason, the Client must make sure, that no more than 1 (one) calendar week has passed, in order to apply for funds depositing. If the payment error occurred more than 1 (one) calendar week before the date of the request, the Company may consider accruing funds to the Client&apos;s balance only if the Client provides full information about the date, time, method of payment, as well as any additional information at the request of the Company.</p>
            <p>9. After clicking the “TO PAY” button the transaction is irrevocably considered to be processed and executed. By placing any order with the Newsems, the Client confirms that he does not violate legislation of any country. Please remember that only you are responsible for paying for all goods and/or services you have requested through the Website and for any additional expenses that can be applied to this payment. Newsems is acting only as the executor of payment in the amount stated by the Client on the Website, and it is not responsible for pricing, total prices and/or total amounts.</p>
            <p>10. In the event that you do not agree with the above-mentioned terms and conditions and/or other reasons, we advise you not to proceed with the payment and contact the support center of Newsems, if it is necessary.</p>
          ...
          <div className="font-medium text-[0.60rem] sm:text-sm space-y-2 md:text-justify">
            <p>1. Newsems does not refund money for the purchased numbers after an SMS message has arrived to the number and activation has been successfully completed. The Client agrees to this provision when he purchases any product and/or service on official websites (Newsems.com; Newsems.ru), in official desktop application and in the telegram bot. If the Customer has not received an SMS message within the specified time, the money for the number will be refunded automatically after the activation is canceled. It is recommended to contact the Newsems support service for help if you face any problems with receiving or using our products.</p>
