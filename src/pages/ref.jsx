...
export default function Ref() {
  return (
    <section>
      <div className="container m-auto md:px-4 xl:px-8">
        <div className="max-w-6xl my-8 mx-auto px-4 xl:px-8">
          ...
          <ol className="list-decimal text-xs space-y-2 mb-4 ml-10 sm:text-lg md:ml-12 md:text-justify">
            <li>Referral program is created exclusively for stimulation of distribution of information about sms-man.com resource.</li>
            <li>Each registered user of sms-man.com can take part in Referral program</li>
            ...
            <li>Referral funds are withdrawn within 24 hours from the moment of application. The minimum amount for withdrawal is 10$. Transfer to user sms-man.com account is instant and without commission </li>
            <li>Administration of SMS-Man has the right to deny withdrawal of funds in case of fraudulent use of the invited users or other abuses of the referral program</li>
          </ol>
