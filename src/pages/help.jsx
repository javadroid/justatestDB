  ...
  return (
    <section className="pb-20">
      <div className="bg-color-bg_light pb-24">
        <div className="bg-color-bg_primary-500 space-y-4 px-4  mx-0 sm:space-y-8 sm:pb-12">
        ...
        <h1 className="mb-7 text-center text-xl font-extrabold md:text-2xl md:pb-10">
          Popular Questions
        </h1>
        <div className="mx-8">
          <Accordion />
      ...
      <div className="pt-10 px-4">
        <div>
          <h2 className="font-extrabold text-lg text-center pb-10 sm:text-2xl md:text-3xl">Instructions for using the service</h2>
        </div>
        <div className="flex justify-between items-start max-w-6xl md:px-8 md:mx-auto">
          ...
          <h3 className="font-extrabold text-center text-xs sm:text-lg md:text-left">How do I register on the site?</h3>
          ...
          <h3 className="font-extrabold text-center text-xs mb-2 sm:text-lg md:text-left">How do I top up my balance?</h3>
          ...
          <h3 className="font-extrabold text-center text-xs my-4 sm:text-lg md:text-left">How do I get a one-time registration number?</h3>
          <ol className="list-decimal text-[10px] pl-8 space-y-4 sm:text-sm">
            ...
            <li>
              ...
              <p className="mt-2"><b>The purchased virtual number will be automatically added to your personal Newsems account.</b></p>
            </li>          
          </ol>

          <h3 className="font-extrabold text-center text-xs my-4 sm:text-lg md:text-left">How do I get an SMS to a purchased number?</h3>
          <ol className="list-decimal text-[10px] pl-8 space-y-4 sm:text-sm">
            <li>
            ...
            <li>
              <p className="mb-2">Go back to your personal Newsems cabinet and press the <strong>Get SMS</strong>  button. If the number can not be used in this service or you have changed your mind to use it, you can cancel the number by clicking on the button <strong> &quot;Cancel activation&quot;</strong></p>
          ...
          <h3 className="font-extrabold text-center text-xs my-4 sm:text-lg md:text-left">How to rent a nubmeer for a very long time?</h3>
          ...
          <p className="mb-2 text-[10px] sm:text-sm">For any questions you may have when reviewing Newsems, there is a <Link href="https://sms-man.com/feedback" className="text-color-primary underline"><span>feedback form</span></Link> open to you. We try to respond promptly to help you with your problem.</p>
          </div>
        </div>
      </div>
    </section>
