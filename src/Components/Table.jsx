...
const Table = () => {
  ...
  return (
    ...
    <div className="hidden lg:block">
      <button className="absolute left-1/3 top-20 w-10 z-50 cursor-pointer rounded-xl bg-color-primary p-2 text-color-white hover:bg-color-primary_black rotate-90 xl:left-[25%]"
